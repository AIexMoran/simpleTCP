...
func (_m *MockClientListenerInterface) SendError(_param0 string) {
	_m.ctrl.Call(_m, "SendError", _param0)
}

// SendError indicates an expected call of SendError
func (_mr *MockClientListenerInterfaceMockRecorder) SendError(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "SendError", reflect.TypeOf((*MockClientListenerInterface)(nil).SendError), arg0)
}
